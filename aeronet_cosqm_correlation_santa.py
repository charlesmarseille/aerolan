...
ax[0].set_yscale('log')
ax[0].set_xlim(pd.Timestamp('2020-02-20 12'), pd.Timestamp('2020-03-05'))
ax[0].set_ylim(2e-2,5.3)
...
plt.setp(ax, xticks=[pd.Timestamp('2020-02-22'), pd.Timestamp('2020-02-27'), pd.Timestamp('2020-03-03')], xticklabels=['2020-02-22', '2020-02-27', '2020-03-03'])
ax.scatter(dt_aod, data_angstrom, s=1.5, label=f'AERONET daytime derived {cosqm_bands[2]}-{cosqm_bands[0]}nm AE')
...
ax[0].scatter(dt_aod, data_aod[:,0], s=msize)
ax[0].scatter(dt_santa_corr[ae_mask], cosqm_aod_r[ae_mask], s=msize)
ax[1].scatter(mpl_may_dates, mpl_may_aod, c='k', marker='+', s=msize/2, label='MPL derived AOD (532nm)')
ax[1].scatter(dt_aod, data_aod[:,2], s=msize, label='AERONET daytime')
ax[1].scatter(dt_santa_corr[ae_mask], cosqm_aod_b[ae_mask], s=msize, label='CoSQM derived AOD')
ax[1].tick_params('x', labelrotation=0)
ax[1].tick_params('x', labelrotation=0)
ax[0].set_yscale('log')
ax[0].set_xlim(pd.Timestamp('2020-05-21 12'), pd.Timestamp('2020-05-29'))
ax[0].set_ylim(0.02,0.81)
ax[1].legend(prop={"size":10}, loc='upper left')
ax[0].text(0.35,0.10, f'{cosqm_bands[0]} nm', horizontalalignment='center', verticalalignment='center', transform=ax[0].transAxes, fontsize=10)
ax[1].text(0.35,0.10, f'{cosqm_bands[2]} nm', horizontalalignment='center', verticalalignment='center', transform=ax[1].transAxes, fontsize=10)
...
msize=1.5
fig, ax = plt.subplots(2,1, sharex=True, sharey=True, dpi=200, figsize=(8,8))
plt.setp(ax, xticks=[pd.Timestamp('2020-07-08'), pd.Timestamp('2020-07-12'), pd.Timestamp('2020-07-16')], xticklabels=['2020-07-08', '2020-07-12', '2020-07-16'])
ax[0].scatter(dt_aod, data_aod[:,0], s=msize)
ax[0].scatter(dt_santa_corr[ae_mask], cosqm_aod_r[ae_mask], s=msize)
...
ax[0].set_ylim(0.02,5.3)
ax[1].legend(prop={"size":6}, loc='lower left')
ax[0].text(0.1,0.3, f'{cosqm_bands[0]} nm', horizontalalignment='center', verticalalignment='center', transform=ax[0].transAxes, fontsize=10)
ax[1].text(0.1,0.3, f'{cosqm_bands[2]} nm', horizontalalignment='center', verticalalignment='center', transform=ax[1].transAxes, fontsize=10)
fig.supxlabel('Time (UTC)', fontsize=10)
fig.supylabel('AOD', fontsize=10)
plt.tight_layout()
...
ax[0].text(0.5,0.10, f'{cosqm_bands[0]} nm', horizontalalignment='center', verticalalignment='center', transform=ax[0].transAxes, fontsize=10)
ax[1].text(0.5,0.10, f'{cosqm_bands[2]} nm', horizontalalignment='center', verticalalignment='center', transform=ax[1].transAxes, fontsize=10)
...
cs = ['r', 'g', 'b', 'y']
ax.scatter(dt_santa, cosqm_santa[:, 1], s=msize*10, c=cs[0], marker='1',alpha=0.8, label=f'{cosqm_bands[0]} nm filtered')
ax.scatter(dt_santa_final, cosqm_santa_final[:, 1], c=cs[0], s=msize, label=f'{cosqm_bands[0]} nm')
ax.scatter(dt_santa, cosqm_santa[:, 3], s=msize*10, c=cs[2], marker='1',alpha=0.8, label=f'{cosqm_bands[2]} nm filtered')
ax.scatter(dt_santa_final, cosqm_santa_final[:, 3], c=cs[2], s=msize, label=f'{cosqm_bands[2]} nm')
ax.set_xlim(pd.Timestamp('2020-05-23 21:50'), pd.Timestamp('2020-05-24 02:10'))
ax.set_ylim(19,20.35)
...
plt.plot(cosqm_responses['WL'], cr[:,0], c='r', linewidth=linewidth, label='red')
plt.plot(cosqm_responses['WL'], cr[:,1], c='g', linewidth=linewidth, label='green')
plt.plot(cosqm_responses['WL'], cr[:,2], c='b', linewidth=linewidth, label='blue')
plt.plot(cosqm_responses['WL'], cr[:,3], c='y', linewidth=linewidth, label='yellow')
plt.grid(b=True)
plt.legend()
plt.xlabel('Wavelenght (nm)')
plt.ylabel('Normalized spectral signal\n in 4 CoSQM bands')
plt.xlim(400,975)
plt.ylim(0)
plt.tight_layout()
...
plt.plot(cosqm_responses['WL'], cr_led[:,1], c='g', linewidth=linewidth, label='green')
plt.plot(cosqm_responses['WL'], cr_led[:,2], c='b', linewidth=linewidth, label='blue')
plt.plot(cosqm_responses['WL'], cr_led[:,3], c='y', linewidth=linewidth, label='yellow')
plt.grid(b=True)
plt.legend()
plt.xlabel('Wavelenght (nm)')
plt.ylabel('Normalized spectral signal\n in 4 CoSQM bands')
