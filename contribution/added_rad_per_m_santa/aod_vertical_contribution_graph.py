...
plt.text(5e3, 3e-12, '505nm, H=2km')
plt.tight_layout()
plt.savefig('santa/added_rad_per_m_505nm_H2.png')
...
plt.xlabel('Vertical distance (m)')
plt.ylabel('Added radiance per meter ($W/str/m^3/nm$)')
plt.text(5e3, 3e-12, '505nm, H=10km')
plt.tight_layout()
plt.savefig('santa/added_rad_per_m_505nm_H10.png')
